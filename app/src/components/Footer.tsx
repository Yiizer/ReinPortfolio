const SOCIALS = [
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/reingabriel-gavino-52822a30b/",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/rein.butter.1/",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer className="border-t border-border py-12 mb-16 sm:mb-0">
